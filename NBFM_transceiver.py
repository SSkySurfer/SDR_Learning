...
# Generated: Mon Feb  1 14:51:21 2021
##################################################
...
class NBFM_transceiver(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.sqch = sqch = -60
        self.sdr_samp_rate = sdr_samp_rate = 1000000
        ...
        for c in range(0, 1):
            self.top_grid_layout.setColumnStretch(c, 1)
        self._sdr_samp_rate_range = Range(520833 , 61440000, 100000, 1000000 , 200)
        ...
        self.pluto_source_0 = iio.pluto_source('', rx_freq, sdr_samp_rate, 25000, 0x4000, True, True, True, "manual", rx_gain*(-(rx_tx)+1), '', True)
        self.pluto_sink_0 = iio.pluto_sink('192.168.2.1', rx_freq-offset, 1920000, 5000, 0x4000, False, -tx_gain*(rx_tx), '', True)
        self.low_pass_filter_0_0 = filter.fir_filter_ccf(1, firdes.low_pass(
        	1, 48e3, 10e3, 2e3, firdes.WIN_HAMMING, 6.76))
        self.low_pass_filter_0 = filter.fir_filter_ccf(1, firdes.low_pass(
        	1, samp_rate, 16000, 1000, firdes.WIN_HAMMING, 6.76))
        self.blocks_wavfile_source_0 = blocks.wavfile_source('C:\\Users\\rswee\\OneDrive\\Documents\\SCHOOL\\ECE531\\caution.wav', True)
        self.blocks_multiply_xx_0 = blocks.multiply_vcc(1)
        self.blocks_multiply_const_vxx_0 = blocks.multiply_const_vff((rx_aud*(-(rx_tx)+1), ))
        self.band_pass_filter_0 = filter.fir_filter_fff(1, firdes.band_pass(
        	1, samp_rate, 200, 20000, 1000, firdes.WIN_HAMMING, 6.76))
    ...
    def set_rx_freq(self, rx_freq):
        ...
        self.qtgui_sink_x_0.set_frequency_range(self.rx_freq, 48000)
        self.pluto_source_0.set_params(self.rx_freq, self.sdr_samp_rate, 25000, True, True, True, "manual", self.rx_gain*(-(self.rx_tx)+1), '', True)
        self.pluto_sink_0.set_params(self.rx_freq-self.offset, 1920000, 5000, -self.tx_gain*(self.rx_tx), '', True)
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 16000, 1000, firdes.WIN_HAMMING, 6.76))
        self.band_pass_filter_0.set_taps(firdes.band_pass(1, self.samp_rate, 200, 20000, 1000, firdes.WIN_HAMMING, 6.76))
